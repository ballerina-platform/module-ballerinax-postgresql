...
public final class Constants {
    ...
    public static final class PGTypeNames {
        ...
        public static final String INET_ARRAY = "InetArray";
        public static final String CIDR = "CidrValue";
        public static final String CIDR_ARRAY = "CidrArray";
        public static final String MACADDR = "MacAddrValue";
        public static final String MACADDR_ARRAY = "MacAddrArray";
        public static final String MACADDR8 = "MacAddr8Value";
        public static final String MACADDR8_ARRAY = "MacAddr8Array";
        ...
        public static final String UUID_ARRAY = "UuidArray";
        public static final String TSVECTOR = "TsVectorValue";
        public static final String TSVECTOR_ARRAY = "TsVectorArray";
        public static final String TSQUERY = "TsQueryValue";
        public static final String TSQUERY_ARRAY = "TsQueryArray";
        ...
        public static final String JSON_BINARY_ARRAY = "JsonBinaryArray";
        public static final String JSON_PATH = "JsonPathValue";
        public static final String JSON_PATH_ARRAY = "JsonPathArray";
        public static final String INTERVAL = "IntervalValue";
        public static final String INT4RANGE = "IntegerRangeValue";
        public static final String INTEGER_RANGE_ARRAY = "IntegerRangeArray";
        public static final String INT8RANGE = "LongRangeValue";
        public static final String LONG_RANGE_ARRAY = "LongRangeArray";
        public static final String NUMRANGE = "NumericRangeValue";
        public static final String NUM_RANGE_ARRAY = "NumericRangeArray";
        public static final String TSRANGE = "TsRangeValue";
        public static final String TIME_STAMP_RANGE_ARRAY = "TsRangeArray";
        public static final String TSTZRANGE = "TsTzRangeValue";
        public static final String TIME_STAMP_Z_RANGE_ARRAY = "TsTzRangeArray";
        public static final String DATERANGE = "DateRangeValue";
        public static final String DATE_RANGE_ARRAY = "DateRangeArray";
        public static final String PGBIT = "PGBitValue";
        public static final String PG_BIT_ARRAY = "PGBitArray";
        public static final String VARBITSTRING = "VarBitStringValue";
        public static final String VAR_BIT_STRING_ARRAY = "VarBitStringArray";
        public static final String BITSTRING = "BitStringValue";
        public static final String BIT_STRING_ARRAY = "BitStringArray";
        public static final String PGLSN = "PglsnValue";
        public static final String PGLSN_ARRAY = "PglsnArray";
        public static final String MONEY = "MoneyValue";
        public static final String MONEY_ARRAY = "MoneyArray";
        public static final String REGCLASS = "RegClassValue";
        public static final String REG_CLASS_ARRAY = "RegClassArray";
        public static final String REGCONFIG = "RegConfigValue";
        public static final String REG_CONFIG_ARRAY = "RegConfigArray";
        public static final String REGDICTIONARY = "RegDictionaryValue";
        public static final String REG_DICTIONARY_ARRAY = "RegDictionaryArray";
        public static final String REGNAMESPACE = "RegNamespaceValue";
        public static final String REG_NAME_SPACE_ARRAY = "RegNamespaceArray";
        public static final String REGOPER = "RegOperValue";
        public static final String REG_OPER_ARRAY = "RegOperArray";
        public static final String REG_OPERATOR = "RegOperatorValue";
        public static final String REG_OPERATOR_ARRAY = "RegOperatorArray";
        public static final String REG_PROC = "RegProcValue";
        public static final String REG_PROC_ARRAY = "RegProcArray";
        public static final String REG_PROCEDURE = "RegProcedureValue";
        public static final String REG_PROCEDURE_ARRAY = "RegProcedureArray";
        public static final String REG_ROLE = "RegRoleValue";
        public static final String REG_ROLE_ARRAY = "RegRoleArray";
        public static final String REG_TYPE = "RegTypeValue";
        public static final String REG_TYPE_ARRAY = "RegTypeArray";
        public static final String XML = "PGXmlValue";
        public static final String XML_ARRAY = "PGXmlArray";
    ...
    */
    ...
    public static final class ArrayTypes {
        public static final String POINT = "point";
        public static final String POINT_ARRAY_VALUE = "PointArray";
        public static final String LINE = "line";
        public static final String LINE_ARRAY_VALUE = "LineArray";
        public static final String LSEG = "lseg";
        public static final String LSEG_ARRAY_VALUE = "LineSegmentArray";
        public static final String BOX = "box";
        public static final String BOX_ARRAY_VALUE = "BoxArray";
        public static final String PATH = "path";
        public static final String PATH_ARRAY_VALUE = "PathArray";
        public static final String POLYGON = "polygon";
        public static final String POLYGON_ARRAY_VALUE = "PolygonArray";
        public static final String CIRCLE = "circle";
        public static final String CIRCLE_ARRAY_VALUE = "CircleArray";
        public static final String INTERVAL = "interval";
        public static final String INTERVAL_ARRAY = "IntervalArray";
        public static final String INT4RANGE = "int4range";
        public static final String INT8RANGE = "int8range";
        public static final String NUMRANGE = "numrange";
        public static final String TSRANGE = "tsrange";
